...
import by.karpov.webcrawler.service.DocumentService;
import by.karpov.webcrawler.service.GetLinkService;
...
GetLinkService getLinkService;
    ...
    private final SpiderBotImpl spiderBot = new SpiderBotImpl(documentService,getLinkService);
